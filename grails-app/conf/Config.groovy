...
grails.plugin.springsecurity.oauthProvider.clientLookup.className = 'com.auth.Client'
grails.plugin.springsecurity.oauthProvider.authorizationCodeLookup.className = 'com.auth.AuthorizationCode'
grails.plugin.springsecurity.oauthProvider.accessTokenLookup.className = 'com.auth.AccessToken'
grails.plugin.springsecurity.oauthProvider.refreshTokenLookup.className = 'com.auth.RefreshToken'

//For excluding client secrets from logg
